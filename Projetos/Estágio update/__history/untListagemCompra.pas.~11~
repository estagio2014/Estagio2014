...
begin
  ...
  begin
  dm.sdsComandoSql.CommandText := 'delete from item_compra where id_compra = :id_compra';
  dm.sdsComandoSql.ParamByName('id_compra').Text := dm.cdsItemCompra.FieldByName('id_compra').Text;
  dm.sdsComandoSql.ExecSQL();
  dm.sdsComandoSql.CommandText := 'delete from compra where id_compra = :id';
  dm.sdsComandoSql.ParamByName('id').Text := dm.cdsCompra.FieldByName('id_compra').Text;
  dm.sdsComandoSql.ExecSQL();
  dm.cdsCompra.Close;
  dm.cdsCompra.Open;
  end;
