    ...
    if rdbPessoaFisica.Checked = true then
      ...
      begin
        ...
        begin
          ...
          if rdbPessoaFisica.Checked = true then
          begin
            dm.sdsComandoSql.ParamByName('tipoPessoa').Text := 'F';
          end
          else if rdbPessoaJuridica.Checked = true then
          begin
            dm.sdsComandoSql.ParamByName('tipoPessoa').Text := 'J';
          end;
          ...
          else if rdbInativo.Checked = true then
          begin
...
begin
  ...
  begin
      MessageDlg('Atenção! RG/ Insc. Estadual digitado ultrapassa 15 digitos!', mtInformation,[mbOk],0);
      edtRg.SetFocus;
      exit;
  end;
end;
...
begin
  ...
  begin
    ...
    if frmListagemCliente.op=2 then
      ...
      if (dm.cdsCliente.FieldByName('situacao').Text = 'A') then
        begin
            rdbAtivo.Checked := True;
        end
      else begin
