object dm: Tdm
  ...
  object sdsContasReceb: TSQLDataSet
    ...
    CommandText = 
      ...
      'sao, vlr_recebido, situacao from fatura inner join lancamento on' +
      ' fatura.id = lancamento.id_venda where id_venda is not null'
    MaxBlobSize = -1
    Params = <>
    SQLConnection = banco
    Left = 432
  ...
  object SQLRelatorioCliente: TSQLDataSet
    ...
    CommandText = 
      'select * from cliente inner join cidade on cliente.id_cid = cida' +
      'de.id_cid '#13#10'where situacao = '#39'A'#39#13#10'order by tipoPessoa'
    MaxBlobSize = -1
    Params = <>
    SQLConnection = banco
    Left = 128
  ...
  object SQLRelatorioFornecedor: TSQLDataSet
    ...
    CommandText = 
      'select * from fornecedor inner join cidade on fornecedor.id_cid ' +
      '= cidade.id_cid'#13#10'where situacao = '#39'A'#39#13#10'order by Nomefant_'
    MaxBlobSize = -1
    Params = <>
    SQLConnection = banco
    Left = 240
