...
begin
 ...
 { end
  ...
  MessageDlg('Erro! A Parcela selecionada está Liquidada ou Estornada!', mtWarning,[mbOk],0);
  exit;
  end;  }
end;
...
begin
  ...
  begin
    MessageDlg('Erro! O estorno da parcela já foi realizado!', mtWarning,[mbOk],0);
    exit;
  end;
...
procedure TfrmListagemContasReceber.DBGrid1TitleClick(Column: TColumn);
begin
  inherited;
  dm.cdsContasReceb.IndexFieldNames := Column.FieldName;
end;
