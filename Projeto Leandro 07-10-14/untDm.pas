...
type
  Tdm = class(TDataModule)
    ...
    SQLDataSetClienteVenda: TSQLDataSet;
    SQLDataSetProduto2: TSQLDataSet;
    SqlRelatorioTodosCli: TSQLDataSet;
    SQLRelatorioContasPagar: TSQLDataSet;
    SQLRelatorioFornecedorData: TSQLDataSet;
    SQLDataSetProdutoData: TSQLDataSet;
    SQLDataSetVendaData: TSQLDataSet;
    SQLRelatorioFaturaData: TSQLDataSet;
    SQLRelatorioContasPagarData: TSQLDataSet;
