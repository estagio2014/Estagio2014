...
procedure Tfrmfiltrofornecedor.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
  if(Key = VK_F3) then
...
procedure Tfrmfiltrofornecedor.FormShow(Sender: TObject);
begin
  inherited;
  rdbFornecedores.Checked := True;
end;
